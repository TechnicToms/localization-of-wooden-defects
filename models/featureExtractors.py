"""From https://github.com/nelson1425/EfficientAD/blob/main/pretraining.py
"""
import torch
...
class FeatureExtractor(torch.nn.Module):
    def __init__(self, backbone, layers_to_extract_from, device: str, input_shape: tuple[int, int, int], out_channels: int):
        ...
        preadapt_aggregator = Aggregator(target_dim=self.out_channels)
    ...
    def embed(self, images):
        ...
        for i in range(1, len(features)):
            ...
            _features: torch.Tensor = _features.reshape(
