...
#
# From https://github.com/google/active-learning/
...
class kCenterGreedy(SamplingMethod):
    ...
    def select_batch_(self, model, already_selected, N, **kwargs):
        ...
        try:
            ...
            # flattened data.
            print(tc.train + "Getting transformed features...")
            self.features = model.transform(self.X)
            print(tc.train + "Calculating distances...")
            self.update_distances(already_selected, only_new=False, reset_dist=True)
        except:
            print(tc.train + "Using flat_X as features.")
        ...
        print(tc.train + "Maximum distance from cluster centers is %0.2f" % max(self.min_distances))
